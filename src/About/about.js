...
const AboutPage = () => {
  return (
    <div className="about-page">
      ...
      <p>
        I'm a full-stack software engineer with over six years of experience in
        IT infrastructure projects including four years of leadership
        experience.
      </p>
      <p>
        During my time working on my food blog where I was working on designing
        the WordPress templates, I got interested in HTML, CSS, and JavaScript.
        That's where I found my passion for development and made a decision to
        switch my career and enroll in a 9-month intensive Full-stack software
        engineering boot camp at Springboard, where I have worked with industry
        experts to work on my skills.
      </p>

      <p>
        I have been actively involved in code reviews and building
        database-driven applications based on Python and Flask. I have spent two
        years with Frontend development and a year with Full stack development.
